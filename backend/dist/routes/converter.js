    ...
    app.post('/convert', async (request, reply) => {
        try {
            ...
            /* =================================================
               HTML -> EDS + XWALK
            ================================================= */
            const result = convertToEdsHtml(mammothResult.value);
            /* =================================================
               VALIDATE RESULT
            ================================================= */
            if (!result.html ||
                ...
                return reply
                    ...
                    .send({
                    success: false,
                    error: 'Conversion returned empty HTML',
                });
            }
            /* =================================================
               FINAL RESPONSE
            ...
            return reply.send({
                 ...
                 * Detected blocks
                 */
                detectedBlocks: result.detectedBlocks,
                /*
                 ...
                 */
                xwalk: {
                    definitions: result.xwalk
                        .definitions,
                    models: result.xwalk
                        .models,
                    filters: result.xwalk
                        .filters,
                },
